--[[
    ========================================================================
        TUAN LO PRO HUB - BẢN ĐỎ PREMIUM (v7.7 FULL MENU STABLE)
    ========================================================================
]]

local LPH_Name = "Tuan Lo Pro Hub"
local LPH_Developer = "Tuan Lo Developer"
local LPH_Version = "v7.7 Stable"
...
local function LoadMainMenu()
    ...
    -- TAB 3: HACK EVADE (Giữ lại Void Mode và Né Netbot mượt mà, loại bỏ tính năng cứu người đã bị game vá cứng)
    ...
    local function ApplyVoidMode()
        ...
        if voidEnabled and currentRoot then
            ...
            voidFixedPosition = currentRoot.Position + Vector3.new(0, 500, 0)
